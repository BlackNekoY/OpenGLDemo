...
public class LightMaterialGLSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private Vector mLightColor = new Vector(1, 1, 1);
    private Vector mLightAmbientColor = new Vector(0.2f, 0.2f, 0.2f);
    private Vector mLightDiffuseColor = new Vector(0.5f, 0.5f, 0.5f);
